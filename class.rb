class Cookie
    ...
    def initialize(title, image, price)
    @title = title
    @price = price
    @image = image
...
get '/' do
    ...
    @muffin = [apple_muffin, berry_muffin,coffee_muffin, carrot_muffin, chocolate_muffin, cranbery_muffin, pumpkin_muffin, mousse_muffin, red_muffin]
    @cookie = [chocolate_chip, smore_cookie, strawberry_jam, peanut_cookie, nutella_cookie, peanutbutter_cookie, shots_cookie, waffle_cookie, coconut_cookie, oatmeal_cookie, kiss_cookie, jaffa_cookie]
    @cake = [chocolate_mousse, lemon_stripe, cheese_cake, jaffa_cake, pineapple_cake, sacher_cake, red_cake, trilece_cake, raffaello_cake]
    erb :homepage
end
